...
| file | cosa verifica |
|---|---|
| `percorso-base.mjs` | materie, orario, creazione di un compito, i tre gesti sulla fila dei giorni, le parti spuntate dall'elenco nei due modi dell'impostazione, i giorni delle singole parti (chip «quando», elenco, calendario), spunta con annulla, un compito di scuola senza nome, l'orario provvisorio e definitivo, le impostazioni a pagine, le cose fatte che restano fino a mezzanotte (anche con l'app aperta davanti), calendario, temi, lingue |
