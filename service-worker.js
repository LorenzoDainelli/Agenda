 ...
 * con la versione nuova quando ce n'è una, senza che l'utente debba fare
 * niente.
 *
 ...
 *
 * Un file .js nuovo va aggiunto a CORE_ASSETS, se no l'app non parte offline
 * (regola 8 del piano).
 */

const CACHE_VERSION = "f73acb8";
