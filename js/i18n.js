...
const DICT = {
  it: {
    ...
    "task.parts.suggested": "Parti consigliate",
    "task.parts.show": "Mostra le parti",
    "task.parts.hide": "Nascondi le parti",
    "task.window.optional": "facoltativo",
    "part.suggest.exercises": "Esercizi",
    "part.suggest.study": "Studiare",
    "mode.theory": "Teoria",
    ...
    "shop.swipe.hint": "Fai scorrere una riga verso sinistra per correggerla, verso destra per toglierla.",
    "shop.edit": "Correggi",
    "shop.remove": "Togli",
    "shop.remove.confirm": "Tolgo «{name}» dalla lista?",
    "shop.removed": "Tolta «{name}»",
    "shop.taken": "C'è già «{name}»: niente è cambiato",
    ...
    "settings.subjects.lab.no": "Solo teoria",
    "settings.subjects.lab.yes": "Teoria e laboratorio",
  ...
  en: {
    ...
    "task.parts.suggested": "Suggested parts",
    "task.parts.show": "Show the parts",
    "task.parts.hide": "Hide the parts",
    "task.window.optional": "optional",
    "part.suggest.exercises": "Exercises",
    "part.suggest.study": "Study",
    "mode.theory": "Theory",
    "mode.lab": "Lab",
    "mode.lab.short": "Lab",
    ...
    "shop.swipe.hint": "Swipe a row left to edit it, right to remove it.",
    "shop.edit": "Edit",
    "shop.remove": "Remove",
    "shop.remove.confirm": "Remove “{name}” from the list?",
    "shop.removed": "Removed “{name}”",
    "shop.taken": "“{name}” is already there: nothing changed",
    ...
    "settings.subjects.lab.no": "Theory only",
    "settings.subjects.lab.yes": "Theory and lab",
