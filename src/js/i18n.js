...
const DICT = {
  it: {
    ...
    "task.parts.study": "Cosa studiare",
    ...
    "shop.bought.note": "Un tocco la rimette in lista.",
    "shop.clear": "Svuota",
    "shop.clear.confirm": "Tolgo le {n} cose già comprate? La lista da comprare resta com'è.",
  ...
  en: {
    ...
    "task.parts.study": "What to study",
    ...
    "shop.bought.note": "One tap puts it back on the list.",
    "shop.clear": "Clear",
    "shop.clear.confirm": "Remove the {n} things already bought? The list to buy stays as it is.",
